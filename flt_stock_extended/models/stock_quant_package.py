...
class StockQuantPackage(models.Model):
    ...
    peso_bruto = fields.Float(string="Peso bruto", compute='_compute_totals', store=True)
    peso_neto = fields.Float(string="Peso neto", compute='_compute_totals', store=True)
