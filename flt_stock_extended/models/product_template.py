    ...
    def _compute_codificacion(self):
        for record in self:
            if record.product_category == 'hilo':
                record.codificacion = f"{record.product_rubro_id.code if record.product_rubro_id else ''}-{record.product_familia_id.code if record.product_familia_id else ''}-{record.product_material_id.code if record.product_material_id else ''}-{record.product_detalle_id.code if record.product_detalle_id else ''}-{record.product_titulo_id.code if record.product_titulo_id else ''}-{record.product_tenido_id.code if record.product_tenido_id else ''}-{record.product_color_id.code if record.product_color_id else ''}-{record.product_otros_id.code if record.product_otros_id else ''}"
            elif record.product_category == 'avio':
                record.codificacion = f"{record.product_rubro_id.code if record.product_rubro_id else ''}-{record.product_familia_id.code if record.product_familia_id else ''}-{record.product_material_id.code if record.product_material_id else ''}-{record.product_type_id.code if record.product_type_id else ''}-{record.product_model_id.code if record.product_model_id else ''}-{record.product_medida_id.code if record.product_medida_id else ''}-{record.product_color_id.code if record.product_color_id else ''}-{record.product_texto_id.code if record.product_texto_id else ''}-{record.product_talla_id.code if record.product_talla_id else ''}-{record.product_otros_id.code if record.product_otros_id else ''}"
            else:
                record.codificacion = ''
