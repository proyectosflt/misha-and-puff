        ...
        for ml, vals in zip(mls, vals_list):
            ...
            if ml.state == 'done':
                ...
                if ml.product_id.type == 'product':
                    ...
                    in_date = None
                    available_qty, in_date = Quant._update_available_quantity(ml.product_id, ml.location_id, -quantity, lot_id=ml.lot_id, package_id=ml.package_id, owner_id=ml.owner_id, gross_weight=-ml.gross_weight, cone_quantity=-ml.cone_quantity)
                    if available_qty < 0 and ml.lot_id:
                        # see if we can compensate the negative quants with some untracked quants
                        untracked_qty = Quant._get_available_quantity(ml.product_id, ml.location_id, lot_id=False, package_id=ml.package_id, owner_id=ml.owner_id, strict=True)
                        if untracked_qty:
                            taken_from_untracked_qty = min(untracked_qty, abs(quantity))
                            Quant._update_available_quantity(ml.product_id, ml.location_id, -taken_from_untracked_qty, lot_id=False, package_id=ml.package_id, owner_id=ml.owner_id, gross_weight=-ml.gross_weight, cone_quantity=-ml.cone_quantity)
                            Quant._update_available_quantity(ml.product_id, ml.location_id, taken_from_untracked_qty, lot_id=ml.lot_id, package_id=ml.package_id, owner_id=ml.owner_id, gross_weight=ml.gross_weight, cone_quantity=ml.cone_quantity)
                    Quant._update_available_quantity(ml.product_id, ml.location_dest_id, quantity, lot_id=ml.lot_id, package_id=ml.result_package_id, owner_id=ml.owner_id, in_date=in_date, gross_weight=ml.gross_weight, cone_quantity=ml.cone_quantity)
        ...
        if updates or 'qty_done' in vals:
            ...
            for ml in mls:
                ...
                in_date = Quant._update_available_quantity(ml.product_id, ml.location_dest_id, -qty_done_orig, lot_id=ml.lot_id,
                                                      package_id=ml.result_package_id, owner_id=ml.owner_id, gross_weight=-ml.gross_weight, cone_quantity=-ml.cone_quantity)[1]
                Quant._update_available_quantity(ml.product_id, ml.location_id, qty_done_orig, lot_id=ml.lot_id,
                                                      package_id=ml.package_id, owner_id=ml.owner_id, in_date=in_date, gross_weight=ml.gross_weight, cone_quantity=ml.cone_quantity)
                ...
                gross_weight = vals.get('qty_done', ml.gross_weight)
                cone_quantity = vals.get('qty_done', ml.cone_quantity)
                ...
                if not float_is_zero(quantity, precision_digits=precision):
                    available_qty, in_date = Quant._update_available_quantity(product_id, location_id, -quantity, lot_id=lot_id, package_id=package_id, owner_id=owner_id, gross_weight=-gross_weight, cone_quantity=-cone_quantity)
                    if available_qty < 0 and lot_id:
                        ...
                        if untracked_qty:
                            ...
                            Quant._update_available_quantity(product_id, location_id, -taken_from_untracked_qty, lot_id=False, package_id=package_id, owner_id=owner_id, gross_weight=-gross_weight, cone_quantity=-cone_quantity)
                            Quant._update_available_quantity(product_id, location_id, taken_from_untracked_qty, lot_id=lot_id, package_id=package_id, owner_id=owner_id, gross_weight=gross_weight, cone_quantity=cone_quantity)
                            if not ml.move_id._should_bypass_reservation(location_id):
                                ml._free_reservation(ml.product_id, location_id, untracked_qty, lot_id=False, package_id=package_id, owner_id=owner_id)
                    Quant._update_available_quantity(product_id, location_dest_id, quantity, lot_id=lot_id, package_id=result_package_id, owner_id=owner_id, in_date=in_date, gross_weight=gross_weight, cone_quantity=cone_quantity)
